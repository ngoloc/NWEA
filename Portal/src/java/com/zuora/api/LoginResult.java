...
public class LoginResult implements org.apache.axis2.databinding.ADBBean {
	 ...
	 * LoginResult Namespace URI = http://api.zuora.com/ Namespace Prefix = ns1
	 */
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null)
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":LoginResult", xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "LoginResult", xmlWriter);
            }
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static LoginResult parse(javax.xml.stream.XMLStreamReader reader)
            ...
            try {
                        ...
                        if (!"LoginResult".equals(type)) {
                            ...
                            java.lang.String nsUri = reader
                                    .getNamespaceContext().getNamespaceURI(
                                            nsPrefix);
                            return (LoginResult) com.zuora.api.object.ExtensionMapper
                ...
                if (reader.isStartElement()
                    ...
                    if (!"true".equals(nillableValue)
                        ...
                        object.setServerUrl(org.apache.axis2.databinding.utils.ConverterUtil
                                .convertToString(content));
