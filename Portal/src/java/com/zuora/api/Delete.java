        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null)
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":delete", xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "delete", xmlWriter);
        ...
        public static Delete parse(javax.xml.stream.XMLStreamReader reader)
            ...
            try {
                        ...
                        if (!"delete".equals(type)) {
                            ...
                            java.lang.String nsUri = reader
                                    .getNamespaceContext().getNamespaceURI(
                                            nsPrefix);
                            return (Delete) com.zuora.api.object.ExtensionMapper
                ...
                if (reader.isStartElement()
                    ...
                    list2.add(com.zuora.api.ID.Factory.parse(reader));
                    ...
                    while (!loopDone2) {
                        ...
                        if (reader.isEndElement()) {
                            ...
                            if (new javax.xml.namespace.QName(
                                ...
                                list2.add(com.zuora.api.ID.Factory
                                        .parse(reader));
                    ...
                    object.setIds((com.zuora.api.ID[]) org.apache.axis2.databinding.utils.ConverterUtil
                            .convertToArray(com.zuora.api.ID.class, list2));
