...
/**
 * RatePlanChargeData bean class
 */
@SuppressWarnings({"unchecked", "unused"})
public class RatePlanChargeData implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name =
	 * RatePlanChargeData Namespace URI = http://api.zuora.com/ Namespace Prefix
	 * = ns1
	 */
    ...
    /**
     * field for RatePlanChargeTier This was an Array!
     */
    ...
    /**
     * validate the array for RatePlanChargeTier
     */
    protected void validateRatePlanChargeTier(
    ...
    public void setRatePlanChargeTier(
        ...
        validateRatePlanChargeTier(param);
     ...
     *
     * @param param com.zuora.api.object.RatePlanChargeTier
     */
    public void addRatePlanChargeTier(
            com.zuora.api.object.RatePlanChargeTier param) {
        if (localRatePlanChargeTier == null) {
            localRatePlanChargeTier = new com.zuora.api.object.RatePlanChargeTier[]{};
        }
        ...
        java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil
                .toList(localRatePlanChargeTier);
        list.add(param);
        this.localRatePlanChargeTier = (com.zuora.api.object.RatePlanChargeTier[]) list
                .toArray(new com.zuora.api.object.RatePlanChargeTier[list
                        .size()]);
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null)
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":RatePlanChargeData", xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
        ...
        if (localRatePlanChargeTierTracker) {
            if (localRatePlanChargeTier != null) {
                for (int i = 0; i < localRatePlanChargeTier.length; i++) {
                    if (localRatePlanChargeTier[i] != null) {
                        localRatePlanChargeTier[i].serialize(
            ...
            if (localRatePlanChargeTier != null) {
                for (int i = 0; i < localRatePlanChargeTier.length; i++) {
                    ...
                    if (localRatePlanChargeTier[i] != null) {
                        ...
                        elementList.add(localRatePlanChargeTier[i]);
                    } else {
                ...
                elementList.add(new javax.xml.namespace.QName(
                        "http://api.zuora.com/", "RatePlanChargeTier"));
                elementList.add(localRatePlanChargeTier);
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static RatePlanChargeData parse(
                javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            RatePlanChargeData object = new RatePlanChargeData();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"RatePlanChargeData".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader
                                    .getNamespaceContext().getNamespaceURI(
                                            nsPrefix);
                            return (RatePlanChargeData) com.zuora.api.object.ExtensionMapper
                ...
                if (reader.isStartElement()
                    ...
                    if ("true".equals(nillableValue)
                        ...
                        list2.add(com.zuora.api.object.RatePlanChargeTier.Factory
                                .parse(reader));
                    }
                    ...
                    while (!loopDone2) {
                        ...
                        if (reader.isEndElement()) {
                            ...
                            if (new javax.xml.namespace.QName(
                                    "http://api.zuora.com/",
                                    "RatePlanChargeTier").equals(reader
                                    .getName())) {
                    ...
                    object.setRatePlanChargeTier((com.zuora.api.object.RatePlanChargeTier[]) org.apache.axis2.databinding.utils.ConverterUtil
                            .convertToArray(
                                    com.zuora.api.object.RatePlanChargeTier.class,
                                    list2));
