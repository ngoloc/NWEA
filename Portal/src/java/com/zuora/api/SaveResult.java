...
public class SaveResult implements org.apache.axis2.databinding.ADBBean {
	 ...
	 * SaveResult Namespace URI = http://api.zuora.com/ Namespace Prefix = ns1
	 */
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null)
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":SaveResult", xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "SaveResult", xmlWriter);
            }
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static SaveResult parse(javax.xml.stream.XMLStreamReader reader)
                        ...
                        if (!"SaveResult".equals(type)) {
                            ...
                            java.lang.String nsUri = reader
                                    .getNamespaceContext().getNamespaceURI(
                                            nsPrefix);
                            return (SaveResult) com.zuora.api.object.ExtensionMapper
