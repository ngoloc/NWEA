...
public class SessionHeader implements org.apache.axis2.databinding.ADBBean {
    ...
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
            "http://api.zuora.com/", "SessionHeader", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null)
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":SessionHeader", xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "SessionHeader", xmlWriter);
            }
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static SessionHeader parse(
                        ...
                        if (!"SessionHeader".equals(type)) {
                            ...
                            java.lang.String nsUri = reader
                                    .getNamespaceContext().getNamespaceURI(
                                            nsPrefix);
                            return (SessionHeader) com.zuora.api.object.ExtensionMapper
