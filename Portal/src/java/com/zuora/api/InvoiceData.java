...
/**
 * InvoiceData bean class
 */
@SuppressWarnings({"unchecked", "unused"})
public class InvoiceData implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name =
	 * InvoiceData Namespace URI = http://api.zuora.com/ Namespace Prefix = ns1
	 */
    ...
    /**
     * field for InvoiceItem This was an Array!
     */
    ...
    /**
     * validate the array for InvoiceItem
     */
    protected void validateInvoiceItem(com.zuora.api.object.InvoiceItem[] param) {
     ...
     *
     * @param param com.zuora.api.object.InvoiceItem
     */
    public void addInvoiceItem(com.zuora.api.object.InvoiceItem param) {
        if (localInvoiceItem == null) {
            localInvoiceItem = new com.zuora.api.object.InvoiceItem[]{};
        }
        ...
        java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil
                .toList(localInvoiceItem);
        list.add(param);
        this.localInvoiceItem = (com.zuora.api.object.InvoiceItem[]) list
                .toArray(new com.zuora.api.object.InvoiceItem[list.size()]);
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (localInvoiceItemTracker) {
            if (localInvoiceItem != null) {
                for (int i = 0; i < localInvoiceItem.length; i++) {
                    if (localInvoiceItem[i] != null) {
                        localInvoiceItem[i]
                                .serialize(
                                        new javax.xml.namespace.QName(
                                                "http://api.zuora.com/",
                                                "InvoiceItem"), xmlWriter);
                    } else {
            ...
            if (localInvoiceItem != null) {
                for (int i = 0; i < localInvoiceItem.length; i++) {
                    ...
                    if (localInvoiceItem[i] != null) {
                        ...
                        elementList.add(localInvoiceItem[i]);
                    } else {
                ...
                elementList.add(new javax.xml.namespace.QName(
                        "http://api.zuora.com/", "InvoiceItem"));
                elementList.add(localInvoiceItem);
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static InvoiceData parse(javax.xml.stream.XMLStreamReader reader)
            ...
            try {
                        ...
                        if (!"InvoiceData".equals(type)) {
                            ...
                            java.lang.String nsUri = reader
                                    .getNamespaceContext().getNamespaceURI(
                                            nsPrefix);
                            return (InvoiceData) com.zuora.api.object.ExtensionMapper
                ...
                if (reader.isStartElement()
                    ...
                    if ("true".equals(nillableValue)
                        ...
                        list2.add(com.zuora.api.object.InvoiceItem.Factory
                                .parse(reader));
                    }
                    ...
                    object.setInvoiceItem((com.zuora.api.object.InvoiceItem[]) org.apache.axis2.databinding.utils.ConverterUtil
                            .convertToArray(
                                    com.zuora.api.object.InvoiceItem.class,
                                    list2));
