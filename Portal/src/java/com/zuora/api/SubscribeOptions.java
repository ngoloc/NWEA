...
/**
 * SubscribeOptions bean class
 */
@SuppressWarnings({"unchecked", "unused"})
public class SubscribeOptions implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name =
	 * SubscribeOptions Namespace URI = http://api.zuora.com/ Namespace Prefix =
	 * ns1
	 */
    ...
    /**
     * field for SubscribeInvoiceProcessingOptions
     */

    protected com.zuora.api.SubscribeInvoiceProcessingOptions localSubscribeInvoiceProcessingOptions;
     ...
     * include this field in the serialized XML
     */
    protected boolean localSubscribeInvoiceProcessingOptionsTracker = false;

    public boolean isSubscribeInvoiceProcessingOptionsSpecified() {
        return localSubscribeInvoiceProcessingOptionsTracker;
    }

    /**
     * Auto generated getter method
     *
     * @return com.zuora.api.SubscribeInvoiceProcessingOptions
     */
    public com.zuora.api.SubscribeInvoiceProcessingOptions getSubscribeInvoiceProcessingOptions() {
        return localSubscribeInvoiceProcessingOptions;
    }

    /**
     * Auto generated setter method
     *
     * @param param SubscribeInvoiceProcessingOptions
     */
    public void setSubscribeInvoiceProcessingOptions(
            com.zuora.api.SubscribeInvoiceProcessingOptions param) {
        localSubscribeInvoiceProcessingOptionsTracker = true;

        this.localSubscribeInvoiceProcessingOptions = param;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null)
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":SubscribeOptions", xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
        ...
        if (localSubscribeInvoiceProcessingOptionsTracker) {
            if (localSubscribeInvoiceProcessingOptions == null) {

                writeStartElement(null, "http://api.zuora.com/",
                        "SubscribeInvoiceProcessingOptions", xmlWriter);
                ...
                localSubscribeInvoiceProcessingOptions
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        if (localSubscribeInvoiceProcessingOptionsTracker) {
            ...
            elementList
                    .add(localSubscribeInvoiceProcessingOptions == null ? null
                            : localSubscribeInvoiceProcessingOptions);
        }
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static SubscribeOptions parse(
                javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            SubscribeOptions object = new SubscribeOptions();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"SubscribeOptions".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader
                                    .getNamespaceContext().getNamespaceURI(
                                            nsPrefix);
                            return (SubscribeOptions) com.zuora.api.object.ExtensionMapper
                ...
                if (reader.isStartElement()
                    ...
                    if ("true".equals(nillableValue)
                            || "1".equals(nillableValue)) {
                        object.setSubscribeInvoiceProcessingOptions(null);
                        reader.next();
                        ...
                        object.setSubscribeInvoiceProcessingOptions(com.zuora.api.SubscribeInvoiceProcessingOptions.Factory
                                .parse(reader));
