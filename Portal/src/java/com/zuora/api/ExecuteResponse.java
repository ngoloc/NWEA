...
public class ExecuteResponse implements org.apache.axis2.databinding.ADBBean {
    ...
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
            "http://api.zuora.com/", "executeResponse", "ns1");

    /**
     * field for Result This was an Array!
     */

    protected com.zuora.api.ExecuteResult[] localResult;
     ...
     *
     * @return com.zuora.api.ExecuteResult[]
     */
    public com.zuora.api.ExecuteResult[] getResult() {
        return localResult;
    }
     ...
     */
    protected void validateResult(com.zuora.api.ExecuteResult[] param) {
     ...
     * @param param Result
     */
    public void setResult(com.zuora.api.ExecuteResult[] param) {
    ...
    public void addResult(com.zuora.api.ExecuteResult param) {
        ...
        java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil
                .toList(localResult);
        list.add(param);
        this.localResult = (com.zuora.api.ExecuteResult[]) list
                .toArray(new com.zuora.api.ExecuteResult[list.size()]);
        ...
        public static ExecuteResponse parse(
            ...
            try {
                        ...
                        if (!"executeResponse".equals(type)) {
                            ...
                            java.lang.String nsUri = reader
                                    .getNamespaceContext().getNamespaceURI(
                                            nsPrefix);
                            return (ExecuteResponse) com.zuora.api.object.ExtensionMapper
                ...
                if (reader.isStartElement()
                    ...
                    list1.add(com.zuora.api.ExecuteResult.Factory.parse(reader));
                    ...
                    while (!loopDone1) {
                        ...
                        if (reader.isEndElement()) {
                            ...
                            if (new javax.xml.namespace.QName(
                                    "http://api.zuora.com/", "result")
                                    .equals(reader.getName())) {
                                list1.add(com.zuora.api.ExecuteResult.Factory
                                        .parse(reader));
                    ...
                    object.setResult((com.zuora.api.ExecuteResult[]) org.apache.axis2.databinding.utils.ConverterUtil
                            .convertToArray(com.zuora.api.ExecuteResult.class,
                                    list1));
