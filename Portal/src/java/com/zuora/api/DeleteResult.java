...
public class DeleteResult implements org.apache.axis2.databinding.ADBBean {
	 ...
	 * DeleteResult Namespace URI = http://api.zuora.com/ Namespace Prefix = ns1
	 */
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null)
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":DeleteResult", xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "DeleteResult", xmlWriter);
            }
        ...
        if (localIdTracker) {
            if (localId == null) {
                ...
                writeStartElement(null, "http://api.zuora.com/", "id",
                        xmlWriter);
                ...
                localId.serialize(new javax.xml.namespace.QName(
                        "http://api.zuora.com/", "id"), xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static DeleteResult parse(javax.xml.stream.XMLStreamReader reader)
            ...
            try {
                        ...
                        if (!"DeleteResult".equals(type)) {
                            ...
                            java.lang.String nsUri = reader
                                    .getNamespaceContext().getNamespaceURI(
                                            nsPrefix);
                            return (DeleteResult) com.zuora.api.object.ExtensionMapper
                ...
                if (reader.isStartElement()
                    ...
                    if ("true".equals(nillableValue)
                        ...
                        list1.add(com.zuora.api.Error.Factory.parse(reader));
                    }
                        ...
                        if (reader.isEndElement()) {
                            ...
                            if (new javax.xml.namespace.QName(
                                ...
                                if ("true".equals(nillableValue)
                                    ...
                                    list1.add(com.zuora.api.Error.Factory
                                            .parse(reader));
                                }
                            } else {
                                loopDone1 = true;
                    ...
                    object.setErrors((com.zuora.api.Error[]) org.apache.axis2.databinding.utils.ConverterUtil
                            .convertToArray(com.zuora.api.Error.class, list1));
                ...
                if (reader.isStartElement()
                        && new javax.xml.namespace.QName(
                        "http://api.zuora.com/", "id").equals(reader
                        .getName())) {
