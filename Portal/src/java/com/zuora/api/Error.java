...
public class Error implements org.apache.axis2.databinding.ADBBean {
	 ...
	 * Namespace URI = http://api.zuora.com/ Namespace Prefix = ns1
	 */
    ...
    protected com.zuora.api.ErrorCode localCode;
     ...
     * @param param Code
     */
    public void setCode(com.zuora.api.ErrorCode param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (localCodeTracker) {
            if (localCode == null) {
                ...
                writeStartElement(null, "http://api.zuora.com/", "Code",
                        xmlWriter);
                ...
                localCode.serialize(new javax.xml.namespace.QName(
                        "http://api.zuora.com/", "Code"), xmlWriter);
            }
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        if (localCodeTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://api.zuora.com/", "Code"));

            elementList.add(localCode == null ? null : localCode);
        }
        if (localMessageTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://api.zuora.com/", "Message"));
        ...
        public static Error parse(javax.xml.stream.XMLStreamReader reader)
            ...
            try {
                        ...
                        if (!"Error".equals(type)) {
                            ...
                            java.lang.String nsUri = reader
                                    .getNamespaceContext().getNamespaceURI(
                                            nsPrefix);
                            return (Error) com.zuora.api.object.ExtensionMapper
                ...
                if (reader.isStartElement()
                        ...
                        "http://api.zuora.com/", "Code").equals(reader
                        .getName())) {
                    ...
                    if ("true".equals(nillableValue)
                        ...
                        object.setCode(com.zuora.api.ErrorCode.Factory
                                .parse(reader));
                ...
                if (reader.isStartElement()
                        && new javax.xml.namespace.QName(
                        "http://api.zuora.com/", "Field").equals(reader
                        .getName())) {
