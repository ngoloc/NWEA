...
public class Product extends com.zuora.api.object.ZObject implements
        org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = Product
    ...
    protected java.lang.String displayinWebsite__c;

    public String getdisplayinWebsite__c() {
        return this.displayinWebsite__c;
    }

    public void setdisplayinWebsite(String dw) {
        this.displayinWebsite__c = dw;
    }

    protected Boolean component1Tracker;
    ...
    public void setComponent1(String c1) {
        this.component1Tracker = true;
        this.component1 = c1;
    }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        if (localCategoryTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://object.api.zuora.com/", "Category"));
    ...
    public static class Factory {
        ...
        public static Product parse(javax.xml.stream.XMLStreamReader reader)
            ...
            try {
                        ...
                        if (!"Product".equals(type)) {
                            ...
                            java.lang.String nsUri = reader
                                    .getNamespaceContext().getNamespaceURI(
                                            nsPrefix);
                            return (Product) com.zuora.api.object.ExtensionMapper
                ...
                if (reader.isStartElement()
                        && new javax.xml.namespace.QName(
                        "http://object.api.zuora.com/", "Component1__c")
                        .equals(reader.getName())) {
                    ...
                    if ("true".equals(nillableValue)
                        ...
                        object.setComponent1(org.apache.axis2.databinding.utils.ConverterUtil
                                .convertToString(content));
                        reader.next();
                    }
                } // End of if for expected property start element
