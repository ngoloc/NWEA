...
/**
 * RatePlanChargeTier bean class
 */
@SuppressWarnings({"unchecked", "unused"})
public class RatePlanChargeTier extends com.zuora.api.object.ZObject implements
        org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name =
	 * RatePlanChargeTier Namespace URI = http://object.api.zuora.com/ Namespace
	 * Prefix = ns2
	 */
    ...
    /**
     * field for EndingUnit
     */

    protected java.math.BigDecimal localEndingUnit;
     ...
     * include this field in the serialized XML
     */
    protected boolean localEndingUnitTracker = false;

    public boolean isEndingUnitSpecified() {
        return localEndingUnitTracker;
    }
    ...
    public java.math.BigDecimal getEndingUnit() {
        return localEndingUnit;
    }

    /**
     * Auto generated setter method
     *
     * @param param EndingUnit
     */
    public void setEndingUnit(java.math.BigDecimal param) {
        localEndingUnitTracker = true;

        this.localEndingUnit = param;

    }

    /**
     * field for IsOveragePrice
     */

    protected boolean localIsOveragePrice;
     ...
     * include this field in the serialized XML
     */
    protected boolean localIsOveragePriceTracker = false;

    public boolean isIsOveragePriceSpecified() {
        return localIsOveragePriceTracker;
    }
    ...
    public boolean getIsOveragePrice() {
        return localIsOveragePrice;
    }

    /**
     * Auto generated setter method
     *
     * @param param IsOveragePrice
     */
    public void setIsOveragePrice(boolean param) {
        localIsOveragePriceTracker = true;

        this.localIsOveragePrice = param;
    ...
    /**
     * field for PriceFormat
     */

    protected java.lang.String localPriceFormat;
     ...
     * include this field in the serialized XML
     */
    protected boolean localPriceFormatTracker = false;

    public boolean isPriceFormatSpecified() {
        return localPriceFormatTracker;
    }
    ...
    public java.lang.String getPriceFormat() {
        return localPriceFormat;
    }

    /**
     * Auto generated setter method
     *
     * @param param PriceFormat
     */
    public void setPriceFormat(java.lang.String param) {
        localPriceFormatTracker = true;

        this.localPriceFormat = param;
    ...
    /**
     * field for StartingUnit
     */

    protected java.math.BigDecimal localStartingUnit;
     ...
     * include this field in the serialized XML
     */
    protected boolean localStartingUnitTracker = false;

    public boolean isStartingUnitSpecified() {
        return localStartingUnitTracker;
    }
    ...
    public java.math.BigDecimal getStartingUnit() {
        return localStartingUnit;
    }

    /**
     * Auto generated setter method
     *
     * @param param StartingUnit
     */
    public void setStartingUnit(java.math.BigDecimal param) {
        localStartingUnitTracker = true;

        this.localStartingUnit = param;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                    "type", namespacePrefix + ":RatePlanChargeTier", xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                    "type", "RatePlanChargeTier", xmlWriter);
        }
        ...
        if (localEndingUnitTracker) {
            namespace = "http://object.api.zuora.com/";
            writeStartElement(null, namespace, "EndingUnit", xmlWriter);

            if (localEndingUnit == null) {
                // write the nil attribute
                ...
                xmlWriter
                        .writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil
                                .convertToString(localEndingUnit));

            }

            xmlWriter.writeEndElement();
        }
        if (localIsOveragePriceTracker) {
            namespace = "http://object.api.zuora.com/";
            writeStartElement(null, namespace, "IsOveragePrice", xmlWriter);
            ...
            if (false) {
                ...
                xmlWriter
                        .writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil
                                .convertToString(localIsOveragePrice));
            }
        ...
        if (localPriceFormatTracker) {
            namespace = "http://object.api.zuora.com/";
            writeStartElement(null, namespace, "PriceFormat", xmlWriter);

            if (localPriceFormat == null) {
                // write the nil attribute
                ...
                xmlWriter.writeCharacters(localPriceFormat);
        ...
        if (localStartingUnitTracker) {
            namespace = "http://object.api.zuora.com/";
            writeStartElement(null, namespace, "StartingUnit", xmlWriter);

            if (localStartingUnit == null) {
                // write the nil attribute
                ...
                xmlWriter
                        .writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil
                                .convertToString(localStartingUnit));
        ...
        if (localTierTracker) {
            namespace = "http://object.api.zuora.com/";
            writeStartElement(null, namespace, "Tier", xmlWriter);

            if (localTier == java.lang.Integer.MIN_VALUE) {
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        if (localEndingUnitTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://object.api.zuora.com/", "EndingUnit"));

            elementList.add(localEndingUnit == null ? null
                    : org.apache.axis2.databinding.utils.ConverterUtil
                    .convertToString(localEndingUnit));
        }
        if (localIsOveragePriceTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://object.api.zuora.com/", "IsOveragePrice"));
        ...
        if (localPriceFormatTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://object.api.zuora.com/", "PriceFormat"));

            elementList.add(localPriceFormat == null ? null
                    : org.apache.axis2.databinding.utils.ConverterUtil
                    .convertToString(localPriceFormat));
        }
        if (localRatePlanChargeIdTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://object.api.zuora.com/", "RatePlanChargeId"));
        ...
        if (localStartingUnitTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://object.api.zuora.com/", "StartingUnit"));

            elementList.add(localStartingUnit == null ? null
                    : org.apache.axis2.databinding.utils.ConverterUtil
                    .convertToString(localStartingUnit));
        }
        if (localTierTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://object.api.zuora.com/", "Tier"));
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static RatePlanChargeTier parse(
                javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            RatePlanChargeTier object = new RatePlanChargeTier();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"RatePlanChargeTier".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader
                                    .getNamespaceContext().getNamespaceURI(
                                            nsPrefix);
                            return (RatePlanChargeTier) com.zuora.api.object.ExtensionMapper
                ...
                if (reader.isStartElement()
                    ...
                    if (!"true".equals(nillableValue)
                        ...
                        object.setEndingUnit(org.apache.axis2.databinding.utils.ConverterUtil
                ...
                if (reader.isStartElement()
                        && new javax.xml.namespace.QName(
                        "http://object.api.zuora.com/",
                        "IsOveragePrice").equals(reader.getName())) {
                    ...
                    if (!"true".equals(nillableValue)
                        ...
                        object.setIsOveragePrice(org.apache.axis2.databinding.utils.ConverterUtil
                ...
                if (reader.isStartElement()
                    ...
                    if (!"true".equals(nillableValue)
                        ...
                        object.setPriceFormat(org.apache.axis2.databinding.utils.ConverterUtil
                ...
                if (reader.isStartElement()
                    ...
                    if (!"true".equals(nillableValue)
                        ...
                        object.setStartingUnit(org.apache.axis2.databinding.utils.ConverterUtil
                                .convertToDecimal(content));
                ...
                if (reader.isStartElement()
                    ...
                    if (!"true".equals(nillableValue)
                        ...
                        object.setTier(org.apache.axis2.databinding.utils.ConverterUtil
                                .convertToInt(content));

                    } else {

                        object.setTier(java.lang.Integer.MIN_VALUE);
