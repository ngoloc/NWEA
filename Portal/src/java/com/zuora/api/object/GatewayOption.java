...
/**
 * GatewayOption bean class
 */
@SuppressWarnings({"unchecked", "unused"})
public class GatewayOption extends com.zuora.api.object.ZObject implements
        org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name =
	 * GatewayOption Namespace URI = http://object.api.zuora.com/ Namespace
	 * Prefix = ns2
	 */
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                    "type", namespacePrefix + ":GatewayOption", xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                    "type", "GatewayOption", xmlWriter);
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        if (localValueTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://object.api.zuora.com/", "value"));
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static GatewayOption parse(
                javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            GatewayOption object = new GatewayOption();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GatewayOption".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader
                                    .getNamespaceContext().getNamespaceURI(
                                            nsPrefix);
                            return (GatewayOption) com.zuora.api.object.ExtensionMapper
