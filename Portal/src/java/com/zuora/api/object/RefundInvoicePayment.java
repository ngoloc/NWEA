...
/**
 * RefundInvoicePayment bean class
 */
@SuppressWarnings({"unchecked", "unused"})
public class RefundInvoicePayment extends com.zuora.api.object.ZObject
        implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name =
	 * RefundInvoicePayment Namespace URI = http://object.api.zuora.com/
    ...
    /**
     * field for InvoicePaymentId
     */

    protected com.zuora.api.ID localInvoicePaymentId;
     ...
     * include this field in the serialized XML
     */
    protected boolean localInvoicePaymentIdTracker = false;

    public boolean isInvoicePaymentIdSpecified() {
        return localInvoicePaymentIdTracker;
    }
     ...
     * @return com.zuora.api.ID
     */
    public com.zuora.api.ID getInvoicePaymentId() {
        return localInvoicePaymentId;
    }

    /**
     * Auto generated setter method
     *
     * @param param InvoicePaymentId
     */
    public void setInvoicePaymentId(com.zuora.api.ID param) {
        localInvoicePaymentIdTracker = true;

        this.localInvoicePaymentId = param;
    ...
    protected com.zuora.api.ID localRefundId;
    ...
    public boolean isRefundIdSpecified() {
        return localRefundIdTracker;
    }
     ...
     * @return com.zuora.api.ID
     */
    public com.zuora.api.ID getRefundId() {
     ...
     */
    public void setRefundId(com.zuora.api.ID param) {
        localRefundIdTracker = true;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                    "type", namespacePrefix + ":RefundInvoicePayment",
                    xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                    "type", "RefundInvoicePayment", xmlWriter);
        }
        ...
        if (localInvoicePaymentIdTracker) {
            if (localInvoicePaymentId == null) {

                writeStartElement(null, "http://object.api.zuora.com/",
                        "InvoicePaymentId", xmlWriter);
                ...
                localInvoicePaymentId.serialize(new javax.xml.namespace.QName(
                        "http://object.api.zuora.com/", "InvoicePaymentId"),
                        xmlWriter);
            }
        }
        ...
        if (localRefundIdTracker) {
            if (localRefundId == null) {
                ...
                localRefundId.serialize(new javax.xml.namespace.QName(
                        "http://object.api.zuora.com/", "RefundId"), xmlWriter);
            }
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        if (localInvoicePaymentIdTracker) {
            ...
            elementList.add(localInvoicePaymentId == null ? null
                    : localInvoicePaymentId);
        }
        if (localRefundAmountTracker) {
            elementList.add(new javax.xml.namespace.QName(
        ...
        if (localRefundIdTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://object.api.zuora.com/", "RefundId"));

            elementList.add(localRefundId == null ? null : localRefundId);
        }
        if (localUpdatedByIdTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://object.api.zuora.com/", "UpdatedById"));
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static RefundInvoicePayment parse(
                javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            RefundInvoicePayment object = new RefundInvoicePayment();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"RefundInvoicePayment".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader
                                    .getNamespaceContext().getNamespaceURI(
                                            nsPrefix);
                            return (RefundInvoicePayment) com.zuora.api.object.ExtensionMapper
                ...
                if (reader.isStartElement()
                        && new javax.xml.namespace.QName(
                        "http://object.api.zuora.com/",
                        "InvoicePaymentId").equals(reader.getName())) {

                    nillableValue = reader.getAttributeValue(
                            "http://www.w3.org/2001/XMLSchema-instance", "nil");
                    if ("true".equals(nillableValue)
                            || "1".equals(nillableValue)) {
                        object.setInvoicePaymentId(null);
                        reader.next();
                        ...
                        object.setInvoicePaymentId(com.zuora.api.ID.Factory
                                .parse(reader));
                ...
                if (reader.isStartElement()
                    ...
                    if ("true".equals(nillableValue)
                        ...
                        object.setRefundId(com.zuora.api.ID.Factory
                                .parse(reader));
