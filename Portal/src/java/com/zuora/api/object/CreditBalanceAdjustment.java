...
/**
 * CreditBalanceAdjustment bean class
 */
@SuppressWarnings({"unchecked", "unused"})
public class CreditBalanceAdjustment extends com.zuora.api.object.ZObject
        implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name =
	 * CreditBalanceAdjustment Namespace URI = http://object.api.zuora.com/
    ...
    /**
     * field for SourceTransactionId
     */

    protected java.lang.String localSourceTransactionId;
     ...
     * include this field in the serialized XML
     */
    protected boolean localSourceTransactionIdTracker = false;

    public boolean isSourceTransactionIdSpecified() {
        return localSourceTransactionIdTracker;
    }
    ...
    public java.lang.String getSourceTransactionId() {
        return localSourceTransactionId;
    }

    /**
     * Auto generated setter method
     *
     * @param param SourceTransactionId
     */
    public void setSourceTransactionId(java.lang.String param) {
        localSourceTransactionIdTracker = true;

        this.localSourceTransactionId = param;

    }

    /**
     * field for SourceTransactionNumber
     */

    protected java.lang.String localSourceTransactionNumber;
     ...
     * include this field in the serialized XML
     */
    protected boolean localSourceTransactionNumberTracker = false;

    public boolean isSourceTransactionNumberSpecified() {
        return localSourceTransactionNumberTracker;
    }
    ...
    public java.lang.String getSourceTransactionNumber() {
        return localSourceTransactionNumber;
    }

    /**
     * Auto generated setter method
     *
     * @param param SourceTransactionNumber
     */
    public void setSourceTransactionNumber(java.lang.String param) {
        localSourceTransactionNumberTracker = true;

        this.localSourceTransactionNumber = param;

    }

    /**
     * field for SourceTransactionType
     */

    protected java.lang.String localSourceTransactionType;
     ...
     * include this field in the serialized XML
     */
    protected boolean localSourceTransactionTypeTracker = false;

    public boolean isSourceTransactionTypeSpecified() {
        return localSourceTransactionTypeTracker;
    }
    ...
    public java.lang.String getSourceTransactionType() {
        return localSourceTransactionType;
    }

    /**
     * Auto generated setter method
     *
     * @param param SourceTransactionType
     */
    public void setSourceTransactionType(java.lang.String param) {
        localSourceTransactionTypeTracker = true;

        this.localSourceTransactionType = param;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                    "type", namespacePrefix + ":CreditBalanceAdjustment",
                    xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                    "type", "CreditBalanceAdjustment", xmlWriter);
        }
        ...
        if (localSourceTransactionIdTracker) {
            namespace = "http://object.api.zuora.com/";
            writeStartElement(null, namespace, "SourceTransactionId", xmlWriter);

            if (localSourceTransactionId == null) {
                // write the nil attribute
                ...
                xmlWriter.writeCharacters(localSourceTransactionId);

            }

            xmlWriter.writeEndElement();
        }
        if (localSourceTransactionNumberTracker) {
            namespace = "http://object.api.zuora.com/";
            writeStartElement(null, namespace, "SourceTransactionNumber",
                    xmlWriter);

            if (localSourceTransactionNumber == null) {
                // write the nil attribute
                ...
                xmlWriter.writeCharacters(localSourceTransactionNumber);

            }

            xmlWriter.writeEndElement();
        }
        if (localSourceTransactionTypeTracker) {
            namespace = "http://object.api.zuora.com/";
            writeStartElement(null, namespace, "SourceTransactionType",
                    xmlWriter);

            if (localSourceTransactionType == null) {
                // write the nil attribute
                ...
                xmlWriter.writeCharacters(localSourceTransactionType);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        if (localNumberTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://object.api.zuora.com/", "Number"));
        ...
        if (localSourceTransactionIdTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://object.api.zuora.com/", "SourceTransactionId"));

            elementList.add(localSourceTransactionId == null ? null
                    : org.apache.axis2.databinding.utils.ConverterUtil
                    .convertToString(localSourceTransactionId));
        }
        if (localSourceTransactionNumberTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://object.api.zuora.com/", "SourceTransactionNumber"));

            elementList.add(localSourceTransactionNumber == null ? null
                    : org.apache.axis2.databinding.utils.ConverterUtil
                    .convertToString(localSourceTransactionNumber));
        }
        if (localSourceTransactionTypeTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://object.api.zuora.com/", "SourceTransactionType"));

            elementList.add(localSourceTransactionType == null ? null
                    : org.apache.axis2.databinding.utils.ConverterUtil
                    .convertToString(localSourceTransactionType));
        }
        if (localStatusTracker) {
            elementList.add(new javax.xml.namespace.QName(
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static CreditBalanceAdjustment parse(
                javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            CreditBalanceAdjustment object = new CreditBalanceAdjustment();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"CreditBalanceAdjustment".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader
                                    .getNamespaceContext().getNamespaceURI(
                                            nsPrefix);
                            return (CreditBalanceAdjustment) com.zuora.api.object.ExtensionMapper
                ...
                if (reader.isStartElement()
                        && new javax.xml.namespace.QName(
                        "http://object.api.zuora.com/",
                        "SourceTransactionId").equals(reader.getName())) {
                    ...
                    if (!"true".equals(nillableValue)
                        ...
                        object.setSourceTransactionId(org.apache.axis2.databinding.utils.ConverterUtil
                                .convertToString(content));
                ...
                if (reader.isStartElement()
                        && new javax.xml.namespace.QName(
                        "http://object.api.zuora.com/",
                        "SourceTransactionNumber").equals(reader
                        .getName())) {
                    ...
                    if (!"true".equals(nillableValue)
                        ...
                        object.setSourceTransactionNumber(org.apache.axis2.databinding.utils.ConverterUtil
                                .convertToString(content));
                ...
                if (reader.isStartElement()
                        && new javax.xml.namespace.QName(
                        "http://object.api.zuora.com/",
                        "SourceTransactionType").equals(reader
                        .getName())) {
                    ...
                    if (!"true".equals(nillableValue)
                        ...
                        object.setSourceTransactionType(org.apache.axis2.databinding.utils.ConverterUtil
                                .convertToString(content));
