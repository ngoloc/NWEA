...
/**
 * InvoiceAdjustment bean class
 */
@SuppressWarnings({"unchecked", "unused"})
public class InvoiceAdjustment extends com.zuora.api.object.ZObject implements
        org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name =
	 * InvoiceAdjustment Namespace URI = http://object.api.zuora.com/ Namespace
	 * Prefix = ns2
	 */
    ...
    /**
     * field for ImpactAmount
     */

    protected java.math.BigDecimal localImpactAmount;
     ...
     * include this field in the serialized XML
     */
    protected boolean localImpactAmountTracker = false;

    public boolean isImpactAmountSpecified() {
        return localImpactAmountTracker;
    }
    ...
    public java.math.BigDecimal getImpactAmount() {
        return localImpactAmount;
    }

    /**
     * Auto generated setter method
     *
     * @param param ImpactAmount
     */
    public void setImpactAmount(java.math.BigDecimal param) {
        localImpactAmountTracker = true;

        this.localImpactAmount = param;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                    "type", namespacePrefix + ":InvoiceAdjustment", xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                    "type", "InvoiceAdjustment", xmlWriter);
        }
        ...
        if (localImpactAmountTracker) {
            namespace = "http://object.api.zuora.com/";
            writeStartElement(null, namespace, "ImpactAmount", xmlWriter);

            if (localImpactAmount == null) {
                // write the nil attribute
                ...
                xmlWriter
                        .writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil
                                .convertToString(localImpactAmount));
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        if (localImpactAmountTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://object.api.zuora.com/", "ImpactAmount"));

            elementList.add(localImpactAmount == null ? null
                    : org.apache.axis2.databinding.utils.ConverterUtil
                    .convertToString(localImpactAmount));
        }
        if (localInvoiceIdTracker) {
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static InvoiceAdjustment parse(
                javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            InvoiceAdjustment object = new InvoiceAdjustment();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"InvoiceAdjustment".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader
                                    .getNamespaceContext().getNamespaceURI(
                                            nsPrefix);
                            return (InvoiceAdjustment) com.zuora.api.object.ExtensionMapper
                ...
                if (reader.isStartElement()
                    ...
                    if (!"true".equals(nillableValue)
                        ...
                        object.setImpactAmount(org.apache.axis2.databinding.utils.ConverterUtil
                                .convertToDecimal(content));
