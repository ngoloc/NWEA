...
/**
 * ProductRatePlan bean class
 */
@SuppressWarnings({"unchecked", "unused"})
public class ProductRatePlan extends com.zuora.api.object.ZObject implements
        org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name =
	 * ProductRatePlan Namespace URI = http://object.api.zuora.com/ Namespace
	 * Prefix = ns2
	 */

    /**
     * field for ActiveCurrencies
     */

    protected java.lang.String localActiveCurrencies;
     ...
     */
    protected boolean localActiveCurrenciesTracker = false;

    public boolean isActiveCurrenciesSpecified() {
        return localActiveCurrenciesTracker;
    }
    ...
    public java.lang.String getActiveCurrencies() {
        return localActiveCurrencies;
    }

    /**
     * Auto generated setter method
     *
     * @param param ActiveCurrencies
     */
    public void setActiveCurrencies(java.lang.String param) {
        localActiveCurrenciesTracker = true;

        this.localActiveCurrencies = param;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                    "type", namespacePrefix + ":ProductRatePlan", xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                    "type", "ProductRatePlan", xmlWriter);
        }
        ...
        if (localActiveCurrenciesTracker) {
            namespace = "http://object.api.zuora.com/";
            writeStartElement(null, namespace, "ActiveCurrencies", xmlWriter);

            if (localActiveCurrencies == null) {
                // write the nil attribute
                ...
                xmlWriter.writeCharacters(localActiveCurrencies);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        if (localActiveCurrenciesTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://object.api.zuora.com/", "ActiveCurrencies"));

            elementList.add(localActiveCurrencies == null ? null
                    : org.apache.axis2.databinding.utils.ConverterUtil
                    .convertToString(localActiveCurrencies));
        }
        if (localCreatedByIdTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://object.api.zuora.com/", "CreatedById"));
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static ProductRatePlan parse(
                javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            ProductRatePlan object = new ProductRatePlan();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ProductRatePlan".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader
                                    .getNamespaceContext().getNamespaceURI(
                                            nsPrefix);
                            return (ProductRatePlan) com.zuora.api.object.ExtensionMapper
                ...
                if (reader.isStartElement()
                        && new javax.xml.namespace.QName(
                        "http://object.api.zuora.com/",
                        "ActiveCurrencies").equals(reader.getName())) {
                    ...
                    if (!"true".equals(nillableValue)
                        ...
                        object.setActiveCurrencies(org.apache.axis2.databinding.utils.ConverterUtil
