...
public class Export extends com.zuora.api.object.ZObject implements
        org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = Export
    ...
    protected com.zuora.api.ID localFileId;
     ...
     * @return com.zuora.api.ID
     */
    public com.zuora.api.ID getFileId() {
        return localFileId;
    }
     ...
     * @param param FileId
     */
    public void setFileId(com.zuora.api.ID param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                    "type", namespacePrefix + ":Export", xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                    "type", "Export", xmlWriter);
        }
        ...
        if (localFileIdTracker) {
            if (localFileId == null) {
                ...
                localFileId.serialize(new javax.xml.namespace.QName(
                        "http://object.api.zuora.com/", "FileId"), xmlWriter);
            }
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        if (localEncryptedTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://object.api.zuora.com/", "Encrypted"));
        ...
        if (localFileIdTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://object.api.zuora.com/", "FileId"));

            elementList.add(localFileId == null ? null : localFileId);
        }
        if (localFormatTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://object.api.zuora.com/", "Format"));
        ...
        if (localQueryTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://object.api.zuora.com/", "Query"));
        ...
        if (localSizeTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://object.api.zuora.com/", "Size"));
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static Export parse(javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            Export object = new Export();
            ...
            try {
                        ...
                        if (!"Export".equals(type)) {
                            ...
                            java.lang.String nsUri = reader
                                    .getNamespaceContext().getNamespaceURI(
                                            nsPrefix);
                            return (Export) com.zuora.api.object.ExtensionMapper
                ...
                if (reader.isStartElement()
                    ...
                    if (!"true".equals(nillableValue)
                        ...
                        object.setEncrypted(org.apache.axis2.databinding.utils.ConverterUtil
                ...
                if (reader.isStartElement()
                    ...
                    if ("true".equals(nillableValue)
                        ...
                        object.setFileId(com.zuora.api.ID.Factory.parse(reader));
                ...
                if (reader.isStartElement()
                    ...
                    if (!"true".equals(nillableValue)
                        ...
                        object.setFormat(org.apache.axis2.databinding.utils.ConverterUtil
                ...
                if (reader.isStartElement()
                    ...
                    if (!"true".equals(nillableValue)
                        ...
                        object.setZip(org.apache.axis2.databinding.utils.ConverterUtil
                                .convertToBoolean(content));
