...
/**
 * CommunicationProfile bean class
 */
@SuppressWarnings({"unchecked", "unused"})
public class CommunicationProfile extends com.zuora.api.object.ZObject
        implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name =
	 * CommunicationProfile Namespace URI = http://object.api.zuora.com/
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                    "type", namespacePrefix + ":CommunicationProfile",
                    xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                    "type", "CommunicationProfile", xmlWriter);
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        if (localProfileNameTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://object.api.zuora.com/", "ProfileName"));
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static CommunicationProfile parse(
                javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            CommunicationProfile object = new CommunicationProfile();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"CommunicationProfile".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader
                                    .getNamespaceContext().getNamespaceURI(
                                            nsPrefix);
                            return (CommunicationProfile) com.zuora.api.object.ExtensionMapper
