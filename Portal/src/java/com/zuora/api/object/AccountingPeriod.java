...
/**
 * AccountingPeriod bean class
 */
@SuppressWarnings({"unchecked", "unused"})
public class AccountingPeriod extends com.zuora.api.object.ZObject implements
        org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name =
	 * AccountingPeriod Namespace URI = http://object.api.zuora.com/ Namespace
	 * Prefix = ns2
	 */
     ...
     * Auto generated setter method
     *
     * @param param FiscalYear
     */
    public void setFiscalYear(int param) {
        localFiscalYearTracker = true;

        this.localFiscalYear = param;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                    "type", namespacePrefix + ":AccountingPeriod", xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                    "type", "AccountingPeriod", xmlWriter);
        }
        ...
        if (localFiscalYearTracker) {
            namespace = "http://object.api.zuora.com/";
            writeStartElement(null, namespace, "FiscalYear", xmlWriter);

            if (localFiscalYear == java.lang.Integer.MIN_VALUE) {
                ...
                xmlWriter
                        .writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil
                                .convertToString(localFiscalYear));
            }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        attribList.add(new javax.xml.namespace.QName(
                "http://object.api.zuora.com/", "AccountingPeriod"));
        if (localFieldsToNullTracker) {
            if (localFieldsToNull != null) {
                for (int i = 0; i < localFieldsToNull.length; i++) {
        ...
        if (localEndDateTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://object.api.zuora.com/", "EndDate"));
        ...
        if (localFiscalYearTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://object.api.zuora.com/", "FiscalYear"));
        ...
        if (localStartDateTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://object.api.zuora.com/", "StartDate"));
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static AccountingPeriod parse(
                javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            AccountingPeriod object = new AccountingPeriod();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"AccountingPeriod".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader
                                    .getNamespaceContext().getNamespaceURI(
                                            nsPrefix);
                            return (AccountingPeriod) com.zuora.api.object.ExtensionMapper
                ...
                if (reader.isStartElement()
                    ...
                    if (!"true".equals(nillableValue)
                        ...
                        object.setFiscalYear(org.apache.axis2.databinding.utils.ConverterUtil
                                .convertToInt(content));

                    } else {

                        object.setFiscalYear(java.lang.Integer.MIN_VALUE);
